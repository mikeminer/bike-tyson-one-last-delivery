...
$('#sound').onclick=()=>{audio.toggle();$('#sound').textContent=audio.enabled?'♪':'♪̸';$('#sound').setAttribute('aria-label',audio.enabled?'Mute audio':'Enable audio');if(audio.enabled)void audio.start();};
...
function beginReplay(){
  ...
  $('#clip-note').textContent='8 seconds of your chaos. Captions and sound included.';
