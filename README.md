...
The simulation stores sampled transforms from the actual run. The replay selects a scored incident, interpolates four recorded seconds over eight seconds, moves the camera and renders a 360×640 canvas with subtitles. It does not generate a new run and call it a replay.
